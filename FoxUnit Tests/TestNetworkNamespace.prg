**********************************************************************
DEFINE CLASS TestNetworkNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestNetworkNamespace OF TestNetworkNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestMapNetworkDrive1
		local My as My
		My = newobject('My', 'my.vcx')
		lnResult = My.Computer.Network.MapNetworkDrive('J:', '\\ssg002\apps')
		lnFiles  = adir(laDir, 'J:\ACCPAC Query\Query.exe')
		This.AssertEquals('TestMapNetworkDrive did not map J to \\ssg002\apps', ;
			1, lnFiles)
		My.Computer.Network.RemoveNetworkDrive('J:')
	endfunc
	function TestMapNetworkDrive2
		local My as My, ;
			loException as Exception
		My = newobject('My', 'my.vcx')
		try
			lnResult = My.Computer.Network.MapNetworkDrive('J', '\\ssg002\apps')
			This.AssertEquals('TestMapNetworkDrive did not give an error ' + ;
				'when J was specified for the drive letter.', 1, 0)
		catch to loException
			This.AssertEquals('TestMapNetworkDrive did not give error 11' + ;
				'when J was specified for the drive letter.', ;
				loException.ErrorNo, 11)
		endtry
	endfunc
