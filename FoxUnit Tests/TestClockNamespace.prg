**********************************************************************
DEFINE CLASS TestClockNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestClockNamespace OF TestClockNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestLocalTime
		...
		This.AssertEquals('LocalTime did not return local time', ;
	...
	function TestGMTTime
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertEquals('GMTTime did not return correct GMT time', ;
			datetime() + 6 * 60 * 60, My.Computer.Clock.GMTTime)
	endfunc
	
	function TestConvertLocalToGMT
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertEquals('ConvertLocalToGMT did not return correct GMT time', ;
			datetime() + 6 * 60 * 60, ;
			My.Computer.Clock.ConvertLocalToGMT(datetime()))
	endfunc
	
	function TestConvertGMTToLocal
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertEquals('ConvertGMTToLocal did not return correct Local time', ;
			datetime(), ;
			My.Computer.Clock.ConvertGMTToLocal(datetime() + 6 * 60 * 60))
	endfunc
	
	function TestTimeZoneOffset
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertEquals('TimeZoneOffset did not return correct value', ;
			6 * 60 * 60, My.Computer.Clock.TimeZoneOffset)
	endfunc
	
	function TestTimeZoneDescription
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertEquals('TimeZoneDescription did not return correct value', ;
