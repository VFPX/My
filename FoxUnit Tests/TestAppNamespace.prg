**********************************************************************
DEFINE CLASS TestAppNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestAppNamespace OF TestAppNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestExecute
		...
		lnResult = My.App.Execute('\ms\my\my.chm')
		This.AssertTrue('lnResult was ' + transform(lnResult) + ;
			', not >= 32', lnResult >= 32)
	endfunc
