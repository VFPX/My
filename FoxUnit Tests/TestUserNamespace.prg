**********************************************************************
DEFINE CLASS TestUserNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestUserNamespace OF TestUserNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestDisplayName
		...
		This.Assertequals('DisplayName is incorrect', 'Doug Hennig', ;
			My.User.DisplayName)
	endfunc

	function TestUserDomain
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertTrue('UserDomain is incorrect', ;
			upper(My.User.UserDomain) == 'STONEFIELD')
	endfunc

	function TestUserName
		local My as My
		My = newobject('My', 'my.vcx')
		This.AssertTrue('UserName is incorrect', ;
			upper(My.User.UserName) = 'DHENNIG')
	endfunc
