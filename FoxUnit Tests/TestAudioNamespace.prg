**********************************************************************
DEFINE CLASS TestAudioNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestAudioNamespace OF TestAudioNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestPlay
		...
		wait window 'Did DING play?' to lcResult
		This.AssertTrue('The sound did not play', upper(lcResult) = 'Y')
	endfunc
	function TestPlaySystemSound
		local My as My
		My = newobject('My', 'My.vcx')
		My.Computer.Audio.PlaySystemSound('Exclamation')
		wait window 'Did exclamation play?' to lcResult
		This.AssertTrue('The sound did not play', upper(lcResult) = 'Y')
	endfunc
