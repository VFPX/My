**********************************************************************
DEFINE CLASS TestRegistryNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestRegistryNamespace OF TestRegistryNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestSetGetValueDeleteKey
		local My as My
		My = newobject('My', 'My.vcx')
		lcRoot   = 'HKEY_CURRENT_USER\Software\Test\'
		lcKey    = lcRoot + 'Test 1'
		lcValue  = 'TestValue'
		lcResult = 'SomeValue'
		My.Computer.Registry.SetValue(lcKey, lcValue, lcResult)
		lcStored = My.Computer.Registry.GetValue(lcKey, lcValue, 'not found')
		This.AssertEquals('SetValue and GetValue do not agree', lcResult, ;
			lcStored)
		llReturn = My.Computer.Registry.DeleteKey(lcRoot)
		This.AssertEquals('DeleteKey failed', .T., llReturn)
	endfunc

	function TestEnumerateKeyValues
		local My as My
		My = newobject('My', 'My.vcx')
		lcRoot   = 'HKEY_CURRENT_USER\Software\Test'
		lcKey    = lcRoot + '\Test 1'
		My.Computer.Registry.SetValue(lcKey, 'TestValue', 'SomeValue')
		My.Computer.Registry.SetValue(lcKey, 'TestValue2', 'SomeValue2')
		My.Computer.Registry.SetValue(lcKey, 'OtherValue', 'SomeOtherValue')
		loKeys = My.Computer.Registry.EnumerateKeyValues(lcKey)
		This.assertequals('EnumerateKeyValues returned wrong value', 3, ;
			loKeys.Count)
		My.Computer.Registry.DeleteKey(lcRoot)
	endfunc

	function TestEnumerateKeys
		local My as My
		My = newobject('My', 'My.vcx')
		lcRoot   = 'HKEY_CURRENT_USER\Software\Test'
		lcKey    = lcRoot + '\Test'
		My.Computer.Registry.SetValue(lcKey + '1', 'TestValue', 'SomeValue')
		My.Computer.Registry.SetValue(lcKey + '2', 'TestValue2', 'SomeValue2')
		My.Computer.Registry.SetValue(lcKey + '3', 'OtherValue', 'SomeOtherValue')
		loKeys = My.Computer.Registry.EnumerateKeys(lcRoot)
		This.assertequals('EnumerateKeys returned wrong value', 3, ;
			loKeys.Count)
		My.Computer.Registry.DeleteKey(lcRoot)
	endfunc
	...
	function TestDeleteKeyValue
		...
		lcKey   = lcRoot + '\Test1'
		lcValue = 'TestValue'
		My.Computer.Registry.SetValue(lcKey, lcValue, 'SomeValue')
		llReturn = My.Computer.Registry.DeleteKeyValue(lcKey, lcValue)
		This.AssertEquals('DeleteKeyValue returned wrong value', .T., ;
			llReturn)
		My.Computer.Registry.DeleteKey(lcRoot)
	endfunc
