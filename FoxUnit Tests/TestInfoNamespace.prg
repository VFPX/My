**********************************************************************
DEFINE CLASS TestInfoNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestInfoNamespace OF TestInfoNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestApplicationInfo
		...
		lcEXE = 'd:\sfqueryprojects\sfqueryact2005\sfquery.exe'
		My.App.Info.GetApplicationInformation(lcEXE)
		This.Assertequals('GetApplicationInformation did not work', ;
			'Stonefield Software Inc.', My.App.Info.CompanyName)
	endfunc

	function TestDirectoryPath
		local My as My
		My = newobject('My', 'My.VCX')
		This.Assertequals('DirectoryPath did not work', ;
			sys(5) + curdir(), addbs(upper(My.App.Info.DirectoryPath)))
	endfunc
