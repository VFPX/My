**********************************************************************
DEFINE CLASS TestSpecialDirectoriesNamespace as FxuTestCase OF FxuTestCase.prg
**********************************************************************
	#IF .f.
	*
	...
	*
	LOCAL THIS AS TestSpecialDirectoriesNamespace OF TestSpecialDirectoriesNamespace.PRG
	#ENDIF
...
*!*		*********************************************************************
	...
	function TestDesktop
		...
		lcFolder = My.Computer.FileSystem.SpecialDirectories.Desktop
		This.assertequals('Desktop failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\Desktop', lcFolder)
	endfunc

	function TestFavorites
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.Favorites
		This.assertequals('Favorites failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\Favorites', lcFolder)
	endfunc

	function TestMyDocuments
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.MyDocuments
		This.assertequals('MyDocuments failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\My Documents', lcFolder)
	endfunc

	function TestNetHood
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.NetHood
		This.assertequals('NetHood failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\NetHood', lcFolder)
	endfunc

	function TestPrintHood
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.PrintHood
		This.assertequals('PrintHood failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\PrintHood', lcFolder)
	endfunc

	function TestPrograms
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.Programs
		This.assertequals('Programs failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\Start Menu\Programs', ;
			lcFolder)
	endfunc
	...
	function TestStartMenu
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.StartMenu
		This.assertequals('StartMenu failed', ;
			'C:\Documents and Settings\dhennig.STONEFIELD\Start Menu', lcFolder)
	endfunc

	function TestTemp
		local My as My
		My = newobject('My', 'my.vcx')
		lcFolder = My.Computer.FileSystem.SpecialDirectories.Temp
		This.assertequals('Temp failed', ;
			'C:\Documents and Settings\DHENNIG.STONEFIELD\Local Settings\Temp', ;
			lcFolder)
	endfunc
